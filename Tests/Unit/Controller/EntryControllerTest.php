...
/**
 * Test case for class Tx_Visitorsbook_Controller_EntryController.
 *
 * @version $Id$
 ...
 */
class Tx_Visitorsbook_Controller_EntryControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
